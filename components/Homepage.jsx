  ...
  return (
    <main className="grid grid-cols-1 gap-8 place-items-center place-content-center w-full md:grid-cols-2 h-5/6">
      <Image
        ...
        placeholder="blur"
      />
      <div className="flex flex-col items-center gap-3  md:text-left md:items-start  ">
        <div className="self-start pl-4 sm:pl-6 md:pl-0 text-3xl md:text-4xl text-secondary ">
          <h1 className="typewritter-animation">Hi I`m Bryan</h1>
